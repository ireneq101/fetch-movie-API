...
const API_URL =
  "https://api.themoviedb.org/3/tv/top_rated?language=en-US&api_key=3fd2be6f0c70a2a598f084ddfb75487c&page=1";
...
function showMovie(movies) {
  ...
  movies.forEach((movie) => {
    const { name, poster_path, first_air_date, vote_average, overview } =
      movie;
